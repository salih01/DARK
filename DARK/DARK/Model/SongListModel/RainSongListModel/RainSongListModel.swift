...
struct RainSongListModel: Identifiable, Equatable {
    var id = UUID()
    var title: String
...
var rainSongList = [
    ...
    RainSongListModel(title: "Rain on the City Streets", totalTime: "6 Episodes, 3.5 Hours", time: "3:23", subTitle: "Experience the soothing sound of rain falling on city streets, creating a peaceful urban atmosphere.", image: "paris"),
    RainSongListModel(title: "Rain on the City Streets", totalTime: "6 Episodes, 3.5 Hours", time: "3:23", subTitle: "Experience the soothing sound of rain falling on city streets, creating a peaceful urban atmosphere.", image: "love"),
